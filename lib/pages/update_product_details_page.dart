...
class UpdateProductDetailsPage extends StatefulWidget {
  static const String routeName = '/product_details_update';

  @override
  State<UpdateProductDetailsPage> createState() =>
      _UpdateProductDetailsPageState();
}

class _UpdateProductDetailsPageState extends State<UpdateProductDetailsPage> {
              ...
              onPressed: () {
                if (formkey.currentState!.validate()) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text("Update your product")));
                }
              },
                          ...
                          trailing: IconButton(
                            onPressed: () {
                              setState(() {
                                ...
                                _productProvider.updateProductIsAvailableorNot(
                                    product.id!, update);
                              });
                            },
