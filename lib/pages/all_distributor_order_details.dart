...
class AllDistributorOrderDetailsPage extends StatefulWidget {
  static const String routeName = '/all_distributor_order_details';

  @override
  State<AllDistributorOrderDetailsPage> createState() =>
      _AllDistributorOrderDetailsPageState();
}

class _AllDistributorOrderDetailsPageState
    extends State<AllDistributorOrderDetailsPage> {
  ...
  void didChangeDependencies() {
    ...
    _orderProvider.getDistributorOrderDetails(_orderId!);
    ...
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
              onPressed: () {
                _orderProvider.updateDistributorOrderStatus(
                    _orderId!, dropdownvalue!);
